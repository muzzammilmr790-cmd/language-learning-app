    ...
    if (cleaned.length === 6) {
      try {
        ...
        if (completeSignUp.status === "complete") {
          ...
          console.error("Sign up status not complete", completeSignUp);
        }
      } catch (err: any) {
        ...
        if (err.errors && err.errors.length > 0) {
          ...
          setPasswordError(err.message || "Invalid verification code");
        }
      }
    }
  };
        ...
        >
          <View className="px-6 pt-4 flex-1">
            ...
            <View className="gap-4 z-10" style={{ zIndex: 10 }}>
              ...
              {/* Password Input */}
              <View className="border border-neutral-200 rounded-2xl px-4 py-2 bg-white relative flex-row items-center justify-between">
                <View className="flex-1 mr-2">
                  <Text className="text-xs text-neutral-400 font-poppins-bold">Password</Text>
                  <TextInput
                    placeholder="••••••••"
                    placeholderTextColor="#9CA3AF"
              ...
              {passwordError ? (
                <Text className="text-red-500 text-xs font-poppins px-1 -mt-2">{passwordError}</Text>
              ) : null}
            </View>
            ...
            >
              <Text className="text-white text-lg font-poppins-bold">Sign Up</Text>
            </TouchableOpacity>
